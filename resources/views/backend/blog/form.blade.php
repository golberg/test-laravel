...
@section('title', $post->exists ? 'Редактировать '.$post->title : 'Создать новую запись')
...
@section('content')
    ...
    <div class="form-group excerpt">
        {!! Form::label('Короткий тект') !!}
        {!! Form::textarea('excerpt', null, ['class' => 'form-control']) !!}
    </div>

    <div class="form-group">
        {!! Form::label('Полный текст') !!}
        {!! Form::textarea('body', null, ['class' => 'form-control']) !!}
    </div>

    {!! Form::submit($post->exists ? 'Сохранить запись' : 'Создать новую запись', ['class' => 'btn btn-primary']) !!}
